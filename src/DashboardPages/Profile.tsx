      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="pt-24 pb-8 px-8 text-center">
          ...
          <div className="flex justify-center items-center gap-2 mt-3">
            ...
            <span className="bg-[#71BBB2]/10 text-[#4ca89d] px-4 py-1 text-sm sm:text-base font-medium rounded-full">
              {role || "Member"}
            </span>
          </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-center gap-6 text-gray-700 text-sm sm:text-base">
            <div className="flex items-center gap-2">
              <FaEnvelope className="text-[#71BBB2]" />
              <span>{email}</span>
            </div>
            <div className="flex items-center gap-2">
              <FaMapMarkerAlt className="text-[#71BBB2]" />
              <span>{address || "Dhaka, Bangladesh"}</span>
            </div>
            <div className="flex items-center gap-2">
              <FaPhoneAlt className="text-[#71BBB2]" />
              <span>{phone || "+880 123-456-789"}</span>
            </div>
          </div>

          <button className="mt-6 px-8 py-2 bg-[#71BBB2] text-white rounded-full flex items-center gap-2 mx-auto hover:bg-[#5ea49a] transition-all duration-300 shadow-md hover:shadow-lg">
