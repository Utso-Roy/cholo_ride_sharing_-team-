        ...
        <div className="flex flex-col items-center justify-center w-full">
          <div className="bg-white/10 rounded-2xl shadow-lg px-4 py-6 md:px-6 md:py-8 max-w-xs md:max-w-sm mx-auto text-center border border-white/20">
            ...
            <p className="text-white text-sm md:text-base lg:text-lg">
              ই-মেইল দিয়ে পাসওয়ার্ড পুনরুদ্ধার করুন।
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full md:w-2/3 flex items-center justify-center p-4 bg-[#e6f6f5]">
        <div className="card bg-[#e6f6f5] w-full max-w-sm shadow-2xl rounded-3xl mx-auto my-6">
          <div className="card-body text-gray-800">
            <h2 className="text-2xl font-bold text-center mb-4 text-[#71BBB2]">
            ...
            <form onSubmit={handlePassword} className="space-y-4">
              ...
              <button
                type="submit"
                className="btn bg-[#71BBB2] hover:bg-[#5AA29F] text-white border-none w-full"
              >
            ...
            <Link
              to="/forget-password-with-number"
              className="btn bg-white text-[#71BBB2] border border-[#71BBB2] hover:bg-[#e6f6f5] w-full mt-3"
            >
              নাম্বার দিয়ে পুনরুদ্ধার করুন
            </Link>
