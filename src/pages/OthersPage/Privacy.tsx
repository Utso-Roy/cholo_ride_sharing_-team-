        ...
        <div className="min-h-screen bg-[#f0faf8]">
            ...
            <section className="relative h-[500px]  w-full">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4"> গোপনীয়তা ও নিরাপত্তা সেটিংস</h1>
                    <p className="text-lg md:text-xl mb-6">আপনার যাত্রা নিরাপদ ও তথ্য সুরক্ষিত রাখুন।</p>
            ...
            <section className="py-16 bg-[#f0faf8]">
                <div className="w-full px-6 mx-auto text-center">
                    <h2 className="text-4xl font-bold text-[#27445D] mb-4">প্রাইভেসি সেটিংস</h2>
                    <p className="text-gray-600 mb-6">
                        আপনি চাইলে আপনার লোকেশন এবং যাত্রার তথ্য শেয়ার করতে পারেন বা বন্ধ রাখতে পারেন।
                    </p>

                    <div className="flex justify-center items-center gap-4">
                        <span className="text-gray-700 font-medium">Privacy {privacyEnabled ? "On" : "Off"}</span>
                        <InputSwitch
                            checked={privacyEnabled}
                            onChange={(e) => setPrivacyEnabled(e.value)}
                        />
                    </div>
                </div>
            </section>
