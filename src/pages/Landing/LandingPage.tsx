      ...
      <div className="relative min-h-screen lg:min-h-[90vh] overflow-hidden">
        ...
        <Container>
          <div className="relative  flex flex-col lg:flex-row items-center justify-between  overflow-hidden">
            ...
            <div
              data-aos="fade-left"
              className="w-full lg:w-1/2 flex flex-col items-center gap-5 sm:gap-6 lg:gap-7 z-10  "
            >
              {/* Image Gallery */}
              <div
                data-aos="zoom-in"
              ...
              >
                <div className="absolute inset-0 -z-10">
                  <div className="absolute top-1/4 left-0  w-24 sm:w-32 md:w-40 h-24 sm:h-32 md:h-40 rounded-full blur-3xl animate-pulse"></div>
                  <div
                    className="absolute bottom-1/4 right-0 w-32 sm:w-40 md:w-48 h-32 sm:h-40 md:h-48 bg-gradient-to-r rounded-full blur-3xl animate-pulse"
                    style={{ animationDelay: "1s" }}
                  ></div>
                </div>

                {/* Left Image Card */}
                <div className="relative group -mr-4 sm:-mr-6 md:-mr-8 lg:-mr-10 z-10">
