...
import BikeEarnArticle from "../../components/EarningArticle/BikeEarnArticle";
...
export default function BikeStepOne() {
  ...
  const gotoNext = () => {
    ...
    if (!isValid) {
      toast.current?.show({
        ...
        detail: "ধাপ ১-এর প্রয়োজনীয় ঘরগুলো পূরণ করুন।",
      });
      return;
    }
  ...
  return (
    <main >
      <Toast ref={toast} />
      <h1 className="text-4xl font-bold text-[#27445D] mt-8 mb-6 text-center">
        বাইক রাইড দিয়ে আয় করুন
      </h1>
          ...
          <div className="flex flex-col gap-3">
            ...
            <InputText
              ...
              className={classNames({
                "p-invalid": touched.firstName && errs.firstName,
              })}
              placeholder="যেমন: রহিম"
            />
            {touched.firstName && errs.firstName && (
              <small className="p-error">প্রথম অংশ আবশ্যক</small>
            )}
            ...
            <InputText
              ...
              className={classNames({
                "p-invalid": touched.lastName && errs.lastName,
              })}
              placeholder="যেমন: উদ্দিন"
            />
            {touched.lastName && errs.lastName && (
              <small className="p-error">শেষ অংশ আবশ্যক</small>
            )}
            ...
            <InputText
              ...
              className={classNames({
                "p-invalid": touched.phone && errs.phone,
              })}
              placeholder="01XXXXXXXXX"
            />
            {touched.phone && errs.phone && (
              <small className="p-error">সঠিক মোবাইল নম্বর দিন</small>
            )}
            ...
            />
            {touched.city && errs.city && (
              <small className="p-error">শহর নির্বাচন করুন</small>
            )}
