...
const services: ServiceFare[] = [
  ...
  {
    name: "ট্র্যাক সার্ভিস",
    ratePerKm: 30,
    icon: <FaBus className="text-4xl text-[#71BBB2]" />,
  },
  {
    name: "শাটল সার্ভিস",
    ratePerKm: 18,
  ...
  {
    name: "জার্নি প্যাকেজ সিস্টেম",
    ratePerKm: 22,
    icon: <FaMapMarkedAlt className="text-4xl text-[#71BBB2]" />,
  },
  {
    name: "মেডিকেল সার্ভিস / অ্যাম্বুলেন্স",
    ratePerKm: 35,
    icon: <FaAmbulance className="text-4xl text-[#71BBB2]" />,
  },
  {
    name: "প্যাকেজ / পণ্য প্রেরণ",
    ratePerKm: 12,
    icon: <FaShippingFast className="text-4xl text-[#71BBB2]" />,
  },
];
  ...
  return (
    <section className="py-16 bg-[#e6fcf9]">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        {/* Distance Input */}
        <div className="mb-12 flex justify-center gap-4 flex-wrap items-center">
          <InputNumber
            value={distance}
        ...
        <div className="grid gap-6 md:grid-cols-4 sm:grid-cols-2">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition cursor-pointer flex flex-col items-center gap-4"
            >
