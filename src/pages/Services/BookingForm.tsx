...
const BookingForm: React.FC = () => {
    ...
    const onSubmit = async (data: FormData) => {
        try {
            // example: distance & fare calculation (dummy)
            const distance = Math.floor(Math.random() * 15) + 1; // 1-15 km
            const estimatedFare = distance * 15; // 15 tk per km
    ...
    return (
        <motion.div
            ...
            className="p-4 max-w-lg mx-auto mt-10 rounded-lg shadow-lg"
            style={{ backgroundColor: "#274450", color: "#EFE9D5" }}
        >
            <h2 className="text-2xl font-bold mb-4" style={{ color: "#71BBB2" }}>
                Book a Ride
            </h2>
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                <Controller
                    ...
                    render={({ field }) => (
                        <InputText
                            ...
                            className={classNames({ "p-invalid": errors.pickupLocation })}
                        />
                    )}
                />
                {errors.pickupLocation && (
                    <small className="text-red-500">{errors.pickupLocation.message}</small>
                )}
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <InputText
                            ...
                            className={classNames({ "p-invalid": errors.dropLocation })}
                        />
                    )}
                />
                {errors.dropLocation && (
                    <small className="text-red-500">{errors.dropLocation.message}</small>
                )}
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Calendar
                            ...
                            showIcon
                            minDate={new Date()}
                            className={classNames({ "p-invalid": errors.date })}
                        />
                    )}
                />
                {errors.date && (
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <InputText
                            ...
                            className={classNames({ "p-invalid": errors.time })}
                        />
                    )}
                />
                {errors.time && (
                    <small className="text-red-500">{errors.time.message}</small>
                )}
                ...
                <Button
                    ...
                    label="Book Ride"
                    className="mt-4"
                    style={{ backgroundColor: "#71BBB2", borderColor: "#71BBB2" }}
                />
            </form>
        </motion.div>
    );
