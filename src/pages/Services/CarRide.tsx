    ...
    return (
        <div className="relative space-y-12">
            ...
            <motion.section
                ...
                style={{
                    backgroundImage: "url('https://i.ibb.co.com/HTvxSpFd/car.png')",
            ...
            >
                ...
                <div className="relative z-10 text-white px-4">
                    <h1 className="text-3xl md:text-5xl font-bold mb-4">এখনই কার রাইড বুক করুন</h1>
