...
import car1 from "../../assets/servicesimg/17.png"
import car2 from "../../assets/servicesimg/16.png"
    ...
    return (
        <div className="relative ">
            ...
            <motion.section
                ...
                style={{
                    backgroundImage: "url('https://i.ibb.co.com/wNWF0ZS0/Am.png')",
            ...
            >
                ...
                >
                    <h2
                        ...
                        style={{ color: "#274450" }}
                    >
                        কেন অ্যাম্বুলেন্স রাইড ব্যবহার করবেন?
                    </h2>
                 ...
                 backdrop-blur-sm"
                        ...
                        >
                            ...
                            <p className="text-sm font-semibold" style={{ color: "#274450" }}>
                                জরুরি মুহূর্তে দ্রুত অ্যাম্বুলেন্স পৌঁছে যাবে আপনার কাছে।
                            </p>
                        </motion.div>
                 ...
                 backdrop-blur-sm"
                        ...
                        >
                            ...
                            <p className="text-sm font-semibold" style={{ color: "#274450" }}>
                                দিন-রাত যেকোনো সময় অ্যাম্বুলেন্স সেবা পাওয়া যাবে।
                            </p>
                        </motion.div>
                 ...
                 backdrop-blur-sm"
                        ...
                        >
                            <img
                                src={car1}
                                alt="নিরাপদ চিকিৎসা সহায়তা"
                                className="w-full h-[200px] object-cover rounded-lg mb-4"
                            />
                            <h3 className="font-bold text-lg mb-2" style={{ color: "#274450" }}>
                                নিরাপদ চিকিৎসা সহায়তা
                            </h3>
                            <p className="text-sm font-semibold" style={{ color: "#274450" }}>
                                প্রশিক্ষিত স্টাফ ও প্রয়োজনীয় চিকিৎসা সরঞ্জামসহ নিরাপদ যাত্রা নিশ্চিত।
                            </p>
                        </motion.div>
                    </div>
                </motion.section>
