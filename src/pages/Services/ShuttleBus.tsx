...
import car1 from "../../assets/servicesimg/10.png";
import car2 from "../../assets/servicesimg/11.png";
            ...
            >
                ...
                >
                    <h2
                        ...
                        style={{ color: "#274450" }}
                    >
                        কেন শাটল বাস রাইড ব্যবহার করবেন?
                    </h2>
                 ...
                 backdrop-blur-sm"
                        ...
                        >
                            ...
                            <p className="text-sm font-semibold" style={{ color: "#274450" }}>
                                একসাথে একাধিক যাত্রী পরিবহনের মাধ্যমে খরচ কম এবং ভ্রমণ আরও সাশ্রয়ী।
                            </p>
                        </motion.div>
                 ...
                 backdrop-blur-sm"
                        ...
                        >
                            ...
                            <p className="text-sm font-semibold" style={{ color: "#274450" }}>
                                নির্ধারিত সময়সূচি অনুযায়ী শাটল বাস চলাচল করে, তাই দেরির ঝামেলা নেই।
                            </p>
                        </motion.div>
                 ...
                 backdrop-blur-sm"
                        ...
                        >
                            ...
                            <p className="text-sm font-semibold" style={{ color: "#274450" }}>
                                প্রশস্ত সিটিং, এয়ার কন্ডিশনড পরিবেশ এবং নিরাপদ যাত্রার নিশ্চয়তা।
                            </p>
                        </motion.div>
                    </div>
                </motion.section>
